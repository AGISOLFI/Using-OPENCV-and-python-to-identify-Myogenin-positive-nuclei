...
#How to use: 
Open the file Myogenin Expressing Nuclei V5.py and change the file being read into img according to the name of your image of interest. Then simply run the program to complete quantification.
